[can be on the bottom] Acknowledgement: based on https://github.com/EllaKaye/ellakaye.co.uk
...
#### `assets/ddi-theme-light.scss` and `assets/ddi-theme-dark.scss`

I have extensively customised the appearance of my site in the `ddi-theme-light.scss` and `ddi-theme-darks.scss` files and I would strongly encourage you to modify at least the fonts and colours in these to give your site its own distinct visual identity.
